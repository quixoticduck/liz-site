...
/* _includes/forms */
class __TwigTemplate_cd818e4ee03a477366e189043cfda65911b831cffddd7144d22d3c21953548d3 extends Craft\BaseTemplate
{
...
";
    ...
    public function geteditableTableField($__config__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo "\t";
            ob_start();
            $this->loadTemplate("_includes/forms/editableTable", "_includes/forms", 204)->display((isset($context["config"]) ? $context["config"] : null));
            $context["input"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
            // line 205
            echo "\t";
            echo $this->getAttribute($this, "field", array(0 => (isset($context["config"]) ? $context["config"] : null), 1 => (isset($context["input"]) ? $context["input"] : null)), "method");
...
/* 	{% else %}*/
/* 		{% set instructions = config.instructions is defined ? config.instructions -%}*/
